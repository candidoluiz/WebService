...
<meta charset="UTF-8">
<title>Erro</title>
<link rel="stylesheet" type="text/css" href="./Resources/css/erro.css">
</head>
...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			<h1 class="heading">ERRO</h1>
			<p class="subheading">${error}</p><br>
			<input type="button" value="Retornar ao Login"><br>
		</div>
